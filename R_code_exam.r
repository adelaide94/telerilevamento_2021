...
install.packages("rasterVIs") #installo il pacchetto rasterVis con questa libreria posso utilizzare la funzione levelplot
install.packages("RStoolbox") #installo il pacchetto RStoolbox  permette l'uso della Unsupervised Classification
install.packages("rasterdiv") #installo il pacchetto rasterdiv permette di calcolare indici 
install.packages("rgdal") #installo il pacchetto rgdal mi permette di analizzare le firme spettrali
install.packages("ggplot2") #installo il pacchetto ggplot2  mi permette l'uso delle funzioni ggplot
...
setwd("C:/lab/sardegna") #setto la cartella di lavoro 

#Immagine del 16/09/2019
#credo una lista di file 
...
#carico la banda SWIR infrarosso a onde corte, essa ha una risoluzione di 20 m 
...
NBR19 <- (nir19_20m-swir19)/(nir19_20m+swir19) # calcolo l'NBR 2019
plot(NBR19, col=cl)
...
Sard2021_20m <- stack(import21_20m) #la funzione <stack> raggruppa tutti i file della lista in un gruppo unico
...
Sard2019_20m <- stack(import19_20m)  #la funzione <stack> raggruppa tutti i file della lista in un gruppo unico
