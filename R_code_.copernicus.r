...
#liberia per leggere il formato .ncdf4 e devo istallare il pacchettp
...
setwd("C:/lab/")
 ...
 #devo associare il file scaricato al nome 
vegetation_Properties <- raster("c_gls_FAPAR_202006130000_GLOBE_PROBAV_V1.5.1.nc")
vegetation_Properties

# non uso la RGB ho un singolo strado quindi decioo la scala di colori
